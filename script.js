document.addEventListener('DOMContentLoaded', function() {
    ...
    colorPicker.addEventListener('input', autoGenerate);
    fontSize.addEventListener('input', autoGenerate);
    boldCheckbox.addEventListener('change', autoGenerate);
    italicCheckbox.addEventListener('change', autoGenerate);
